...
from besmarts.core.topology import bond_topology, dihedral_topology, angle_topology
...
from besmarts.core import configs, splits
...
splits: split_return_type = splits.split_structures_distributed(splitter, S0, list(frags), wq)
